...
void DataManager::saveAllData(const std::vector<Product>& products, const std::vector<Invoice>& invoices) const {
...
void DataManager::appendInvoiceToLog(const Invoice& invoice) const {
...
void DataManager::saveProducts(const std::vector<Product>& products) const {
...
void DataManager::saveInvoices(const std::vector<Invoice>& invoices)  const {
...
void DataManager::saveOrderItems(const std::vector<Invoice>& invoices) const {
...
std::string DataManager::getInvoiceStringForLog(const Invoice& invoice) const {
